...
//The box we control with keys
        ...
        private UndoManager.Command buttonW, buttonS, buttonA, buttonD, buttonB, buttonZ, buttonR;
        //Stores all commands for replay and undo
        public static List<UndoManager.Command> oldCommands = new List<UndoManager.Command>();
        ...
        void Start(){
            ...
            buttonB = new UndoManager.DoNothing();
            buttonW = new UndoManager.MoveForward();
            buttonS = new UndoManager.MoveReverse();
            buttonA = new UndoManager.MoveLeft();
            buttonD = new UndoManager.MoveRight();
            buttonZ = new UndoManager.UndoCommand();
            buttonR = new UndoManager.ReplayCommand();
